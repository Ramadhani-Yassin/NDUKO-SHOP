                        ...
                        <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                            <div class="pr-12">
                                ...
                                <p class="mt-4 text-lg text-blueGray-200">
                                    NdukoShop is a retail store based in Dodoma, offering a wide range of quality 
                                    products to meet customer needs. We focus on affordability, reliability,
                                     and excellent customer service to ensure a seamless shopping experience.
                                </p>
                                <Link
        ...
        <div class="flex flex-wrap items-center mt-32">
            ...
            <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-emerald-500">
                    <img alt="..." :src="inventoryService" class="w-full align-middle rounded-t-lg" />
    ...
    <div class="container mx-auto px-4">
        <div class="items-center flex flex-wrap">
            <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
                <img alt="..." class="max-w-full rounded-lg shadow-lg" :src="fourthSection" />
            </div>
                    ...
                    <ul class="list-none mt-6">
                        <li class="py-2">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="text-blueGray-500">Responsive Design</h4>
                                </div>
                            </div>
                        </li>
                        <li class="py-2">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="text-blueGray-500">Secure and Reliable</h4>
                                </div>
                            </div>
                        </li>
                        <li class="py-2">
...
<section class="pb-20 relative block bg-blueGray-800">
    ...
    <div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
        <div class="flex flex-wrap text-center justify-center">
            <div class="w-full lg:w-6/12 px-4">
                <h2 class="text-4xl font-semibold text-white">Services Offered</h2>
        ...
        <div class="flex flex-wrap mt-12 justify-center">
            <div class="w-full lg:w-3/12 px-4 text-center">
                ...
                <h6 class="text-xl mt-5 font-semibold text-white">Frontend Development</h6>
            ...
            <div class="w-full lg:w-3/12 px-4 text-center">
                ...
                <h5 class="text-xl mt-5 font-semibold text-white">Backend Development</h5>
                <p class="mt-2 mb-4 text-blueGray-400">
            ...
            <div class="w-full lg:w-3/12 px-4 text-center">
                ...
                <h5 class="text-xl mt-5 font-semibold text-white">Deployment Services</h5>
                <p class="mt-2 mb-4 text-blueGray-400">
