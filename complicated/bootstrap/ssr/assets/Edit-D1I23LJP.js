import { ref, onMounted, unref, withCtx, createTextVNode, createVNode, withDirectives, withKeys, vModelText, vModelSelect, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="flex flex-col"${_scopeId}><label for="root" class="text-stone-600 text-sm font-medium"${_scopeId}>Root</label><input id="root"${ssrRenderAttr("value", unref(form).root)} type="text" placeholder="Enter root" class="mt-2 block w-full rounded-md border border-gray-200 px-2 py-2 shadow-sm outline-none focus:outline-none focus:shadow-outline"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
                      ...
                      createVNode("div", { class: "flex flex-wrap items-center" }, [
                        createVNode("div", { class: "relative w-full px-4 max-w-full flex-grow flex-1" }, [
                          createVNode("div", { class: "flex justify-between items-center" }, [
                            createVNode("h4", { class: "text-2xl" }, "Edit Product"),
                      ...
                      createVNode("div", { class: "grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3" }, [
                        ...
                        createVNode("div", { class: "flex flex-col" }, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            onKeyup: withKeys(updateProduct, ["enter"]),
                            type: "text",
                        ...
                        createVNode("div", { class: "flex flex-col" }, [
                          ...
                          createVNode("div", { class: "flex mt-1" }, [
                            ...
                            withDirectives(createVNode("input", {
                              ...
                              onKeyup: withKeys(_ctx.createProduct, ["enter"]),
                              type: "number",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Product/Edit.vue");
